...
public class LocationManager {
    ...
    public static File folder = new File("plugins/Cores/");
    public static File file = new File("plugins/Cores/locations.yml");
    ...
    public static void setCore(String name, Location loc){
        double x = loc.getBlockX();
        double y = loc.getBlockY() - 1;
        double z = loc.getBlockZ();
        String worldName = loc.getWorld().getName();

        cfg.set("Cores." + name + ".X", x);
        cfg.set("Cores." + name + ".Y", y);
        cfg.set("Cores." + name + ".Z", z);
        cfg.set("Cores." + name + ".worldName", worldName);
        saveLocations();
    }

    public static Location getCore(String name){
        double x = cfg.getDouble("Cores." + name + ".X");
        double y = cfg.getDouble("Cores." + name + ".Y");
        double z = cfg.getDouble("Cores." + name + ".Z");
        String worldName = cfg.getString("Cores." + name + ".worldName");
    ...
    public static Location getBeacon(String name){
